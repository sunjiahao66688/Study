...
model = ChatOpenAI(model="deepseek-chat",api_key=DEEPSEEK_API_KEY,base_url="https://api.deepseek.com/v1")
...
while True:
    print(chain.invoke([HumanMessage(content=input("User："))], config=session_config).content)
